sap.ui.define(
    ...
    function(Controller, formatter, Filter, FilterOperator, Sorter, Fragment) {
      "use strict";
      var that;
      return Controller.extend("project4.controller.ResponsiveMaterial", {
        formatter : formatter,
        ...
        onSort : function () {
            ...
            if(!this.byId("SortDialog")){
                Fragment.load({
                    ...
                    // id : application-project4-display-component---Request (npm으로 build 시)
                    // 특정값으로 지정하지 않을 시 계속 상속하기 때문에 id값을 지정해줌(즉 fragment를 가리킴)
                    name : "project4.view.fragment.SortMaterialDialog",
