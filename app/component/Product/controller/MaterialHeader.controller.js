sap.ui.define(
    ...
    function(Controller, formatter, Filter, FilterOperator, Sorter, Fragment) {
      ...
      return Controller.extend("project4.controller.MaterialHeader", {
        formatter : formatter,
        ...
        //검색을 위한 함수
        onSearch : function () {
            // sap.ui.controller("project4.controller.")
            ...
            sap.ui.controller("project4.controller.ResponsiveMaterial").onSearch(aFilter);
            sap.ui.controller("project4.controller.GridMaterial").onSearch(aFilter);
        ...
        onValueHelpRequest : function(){
            if(!this.byId("compop")){
                Fragment.load({
                    ...
                    name : "project4.view.fragment.MaterialSearch",
                    controller : this
