sap.ui.define(
    [
        ...
        "sap/ui/model/Filter",
    "sap/ui/model/FilterOperator", "sap/ui/model/Sorter", "sap/ui/core/Fragment", "sap/ui/model/json/JSONModel", "sap/m/MessageBox"
    ],
    function(Controller, formatter, Filter, FilterOperator, Sorter, Fragment, JSONModel, MessageBox) {
      ...
      return Controller.extend("project3.controller.GridCompany", {
        ...
        onDeleteRow : async function(oEvent){
            ...
            // });
            await this.onDelete(SelectedNum);
        ...
        onSort : function () {
            ...
            if(!this.byId("SortDialog")){
                Fragment.load({
                    ...
                    // id : application-project3-display-component---Request (npm으로 build 시)
                    // 특정값으로 지정하지 않을 시 계속 상속하기 때문에 id값을 지정해줌(즉 fragment를 가리킴)
                    name : "project3.view.fragment.SortCompanyDialog",
